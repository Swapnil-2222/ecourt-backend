...
describe('LawyerDetails Management Component', () => {
  let comp: LawyerDetailsComponent;
  let fixture: ComponentFixture<LawyerDetailsComponent>;
  let service: LawyerDetailsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'lawyer-details', component: LawyerDetailsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LawyerDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.lawyerDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
